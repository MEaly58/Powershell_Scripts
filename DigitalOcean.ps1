...
# Set a temporary IP address and change it to the droplets
...
#######################################################################
######                                                            #####
######       Below is Code I'm "Borrowing" caus it works          #####
######                                                            #####
#######################################################################
if ($api_key -eq $null)
{
  Write-Host "ERROR: No API key set!" -foregroundcolor red
  break
}
